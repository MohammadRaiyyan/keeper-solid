...
const DatePickerInput = (props: DatePickerPrimitive.InputProps) => {
  ...
  return (
    <DatePickerPrimitive.Input
      class={cn(
        "h-10 w-full rounded-md border border-border  bg-transparent px-3 py-1 text-sm ring-offset-background  transition-shadow placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
        local.class,
      )}
      {...others}
    />
...
const DatePickerTrigger = (props: DatePickerPrimitive.TriggerProps) => {
  ...
  return (
    <DatePickerPrimitive.Trigger
      class={cn(
        "flex min-h-10 min-w-10 items-center justify-center rounded-md border border-border bg-transparent transition-[box-shadow,background-color] hover:bg-accent/50 focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>svg]:size-4",
        local.class,
      )}
      {...others}
    >
...
const DatePickerContent = (props: DatePickerPrimitive.ContentProps) => {
  ...
  return (
    <DatePickerPrimitive.Content
      class={cn(
        "z-50 rounded-md border bg-popover p-3 text-popover-foreground  outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        local.class,
      )}
      {...others}
    >
